    ...
    <div className="rounded-xl overflow-hidden bg-white/5 border border-white/10">
      <div className="bg-white/5 px-5 py-3 border-b border-white/5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-white text-sm">Ask about this content</span>
        </div>
        <span className="text-xs font-semibold uppercase tracking-wider text-slate-500">{remaining} msgs left</span>
      </div>
      ...
      <form
        onSubmit={handleSend}
        className="flex items-center gap-2 p-3 bg-white/3 border-t border-white/5"
      >
        <div className="flex-1 flex items-center gap-2 bg-[#0d0d15] border border-white/15 rounded-lg px-3 py-2">
          <input
            value={input}
          ...
          <button
            ...
            className="text-indigo-400 hover:text-indigo-300 disabled:opacity-30 transition-colors p-0.5"
          >
